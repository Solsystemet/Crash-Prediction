...
async def predict_severity(request: PredictionRequest):
    """Predict crash severity based on input features.

    Takes crash parameters and returns the predicted severity class
    (NO_INJURY, MINOR, SEVERE) along with probability scores.
    """
    try:
